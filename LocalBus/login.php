...
if($_SERVER['REQUEST_METHOD'] === "POST"){
    ...
    if($flag === true){
        ...
        $sql = "Select * from `local_bus_ticketing_system`.`admin` WHERE  email='$emailUser' OR Username='$emailUser' AND password='$password' ";
        // $email $password
                    ...
                    <form action="login.php" method="post" novalidate>
                        <table>
                            ...
                            <tr>
                                ...
                                <td></td>
                                <td></td>
                                <td><p>Don't have an account?<a href="./register.php">Register here</a></p></td>
                            </tr>
